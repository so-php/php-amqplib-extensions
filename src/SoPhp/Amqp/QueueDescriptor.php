...
/**
 * Describes a queue and it's options. Also provides a helper method for declaring
 * queues that correctly maps the properties of the instance to the queue_declare
 * method.
