...
/**
 * Describes an exchange and it's options. Also provides a helper method for declaring
 * exchanges that correctly maps the properties of the instance to the exchange_declare
 * method.
